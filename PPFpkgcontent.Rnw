...
Table \ref{tabfun} shows the complete list of functions included in the package along with a brief description. 
 ...
 \begin{center}
 \begin{table}[!hbpt]
  \isucaption{Summary of functions implemented in \pkg{PPforest}.\label{tabfun}}
...
a
@
\isucaption{Scatter plot matrix for crab data \label{scatercrab}}
\end{figure}
...
\begin{center}
\begin{table}[!hbpt]
 \isucaption{Summary of data included in \pkg{PPforest} package\label{datappf}.}
\begin{tabular}{ l | p{12cm} } \hline
...
The main function of the package is called {\tt PPforest} which implements a projection pursuit random forest. Table \ref{ppforestfun} presents the {\tt PPforest} function arguments and their respective description.
  \begin{center}
 \begin{table}[!hbpt]
 \isucaption{Summary of available arguments of function {\tt PPforest} \label{ppforestfun}.}
  \begin{tabular}{ l | p{12cm} } \hline
...
\begin{center}
 \begin{table}[!hbpt]
\isucaption{Summary of available values of function {\tt PPforest} \label{ppforestout}.}
  \begin{tabular}{ l | p{12cm} } \hline
...
A summary of the arguments and a description for this function is presented in Table \ref{baggtreefun}.
 \begin{center}
 \begin{table}[!ht]
 \isucaption{Summary of available arguments of function {\tt baggtree} \label{baggtreefun}.}
  \begin{tabular}{ l | p{12cm} } \hline
  \textbf{Arguments} & \textbf{Description}\\ \hline
{\tt data} &	Data frame with the complete data set\\ \hline
{\tt class} &	A character with the name of the class variable \\ \hline
...
Table \ref{nodedatfun} contains a summary whit the main argument described for {\tt node\_data}.
 \begin{center}
 \begin{table}[!hbpt]
 \isucaption{Summary of available arguments of function {\tt node\_data} \label{nodedatfun}.}
  \begin{tabular}{ l | p{12cm} } \hline
  \textbf{Arguments} & \textbf{Description}\\ \hline
...
\begin{center}
 \begin{table}[!ht]
 \isucaption{Summary of available arguments of function {\tt node\_data} \label{nodedatout}.}
  \begin{tabular}{ l | p{12cm} } \hline
  \textbf{Value} & \textbf{Description}\\ \hline
...
A summary of available arguments and its description is presented in Table \ref{ppsplitfun}
 \begin{center}
 \begin{table}[!ht]
 \isucaption{Summary of available arguments of function {\tt PPtree\_split} \label{ppsplitfun}.}
  \begin{tabular}{ l | p{12cm} } \hline
  \textbf{Arguments} & \textbf{Description}\\ \hline
...
@
 ...
 \begin{center}
 \begin{table}[!ht]
  \isucaption{Summary of output values of function {\tt PPtree\_split} \label{ppsplitfunout}.}
  \begin{tabular}{ l | p{12cm} } \hline
...
@
\isucaption{Tree structure plot using \pkg{PPtreeViz}}
\end{figure}
...
Table \ref{ppclassfun} shows a summary with the arguments for {\tt PPclassify2} function.
  ...
  \begin{center}
 \begin{table}[!ht]
  \isucaption{Summary of available arguments of function {\tt PPclassify2} \label{ppclassfun}.}
  \begin{tabular}{ l | p{12cm} } \hline
...
\subsection{{\tt trees\_pred}}
 ...
 \begin{center}
 \begin{table}[!ht]
 \isucaption{Summary of available arguments of function {\tt trees\_pred} \label{nodedatfun1}.}
  \begin{tabular}{ l | p{12cm} } \hline
  \textbf{Arguments} & \textbf{Description}\\ \hline
...
Table \ref{ternafun} presents a summary of the available arguments for this function.
 \begin{center}
 \begin{table}[!ht]
 \isucaption{Summary of available arguments of function {\tt ternary\_str} \label{ternafun}.}
  \begin{tabular}{ l | p{12cm} } \hline
  \textbf{Arguments} & \textbf{Description}\\ \hline
{\tt ppf}	&Is a PPforest object\\ \hline
...
@
\isucaption{Generalized ternary plot ((G-1)-D simplex, here it is a tetrahedron) representation of the vote matrix for four classes. The tetrahedron is shown pairwise. Each point corresponds to one observation and color is the true class. This is close but not a perfect classification, since the colors are concentrated in the corners and there are some mixed colors in each corner. }
\end{figure}
\newpage
...
@
\isucaption{Dot plot with the permuted importance measure for a PPforest object}
\end{figure}
