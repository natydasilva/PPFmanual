...
This function predict the class for the test set and compute the predicted error rate form a PPtree object.
Table 
...
@
\subsection{{\tt permute\_importance}}



\subsection{{\tt ppf\_avg\_pptree\_imp}}
\subsection{{\tt ppf\_global\_imp}}
\subsection{{\tt print.PPforest}}
